  ...
  return <div className="dashboard-page">
    <div className="workspace-shell">
      ...
      <main className="workspace-main">
        ...
        <section className="tool-section"><div className="section-heading"><div><span className="eyebrow">CAREER TOOLKIT</span><h2>Build, optimise, practise</h2></div><Link to="/healthcare-guide">Explore guidance <FiArrowRight /></Link></div><div className="tool-grid"><Link to="/ats-checker" className="tool-card featured"><div className="tool-icon"><FiSearch /></div><div><span>CV INTELLIGENCE</span><h3>ATS Checker</h3><p>Upload your CV and see what to improve before applying.</p></div><FiArrowRight /></Link><Link to="/career-copilot" className="tool-card"><div className="tool-icon"><FiTarget /></div><div><span>AI CAREER COPILOT</span><h3>Target a vacancy</h3><p>Compare your CV with a job and close the gaps.</p></div><FiArrowRight /></Link><Link to="/interview-coach" className="tool-card"><div className="tool-icon"><FiMic /></div><div><span>AI INTERVIEW</span><h3>Mock interview</h3><p>Answer realistic healthcare questions and get feedback.</p></div><FiArrowRight /></Link><Link to="/practice-questions" className="tool-card"><div className="tool-icon"><FiCheckCircle /></div><div><span>PRACTICE LAB</span><h3>Practice questions</h3><p>Build confidence one healthcare question at a time.</p></div><FiArrowRight /></Link></div></section>
