...
export default function Home() {
  return <main className="landing-page healthcare-home">
    ...
    <section className="final-cta"><div><span>FIRST PDF FREE</span><h2>Make your next healthcare application count.</h2><p>Create, edit and download your first healthcare CV free after sign-in.</p></div><Link className="light-action" to="/get-started">Create my CV <FiArrowRight /></Link></section>
  </main>;
}
