...
export default function Home() {
  return <main className="landing-page healthcare-home">
    ...
    <section className="final-cta"><div><span>START FREE</span><h2>Make your next healthcare application count.</h2><p>Create, verify and download your first watermark-free CV at no cost.</p></div><Link className="light-action" to="/get-started">Create my CV <FiArrowRight /></Link></section>
  </main>;
}
